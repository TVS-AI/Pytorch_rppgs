...
def test(model, test_loader, check_model, device):
    ...
    for i in range(0, 1):
        with torch.no_grad():
            ...
            for k, (avg, mot, lab) in tqdm(enumerate(test_loader), desc="mask : ", total=len(test_loader)):
            ...
            print("End : Inference")
            # Save Attention Mask
            data_file = h5py.File('/home/js/Desktop/Data/Pytorch_rppgs_save/preprocessing/mask/UBFC_mask_Data.hdf5',
                                  'w')
